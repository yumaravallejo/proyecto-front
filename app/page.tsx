  ...
  return (
    <>
      ...
      <div className="dashboard pb-10 pt-17 w-full bg-[var(--gris-oscuro)] flex flex-col items-center justify-center">
        ...
        <div id="experiencia" className="w-full bg-white pt-4 sm:pt-10 sm:pb-10">
          <h2 className="oswald font-semibold text-white fondo-dash text-center p-2 text-3xl">
            EXPERIENCIA CHANGES
          </h2>
          <div className="flex justify-center">
            <p className="p-7 text-justify text-sm w-10">
        ...
        <div className="flex flex-col gap-y-2 text-left w-full items-center mb-[-5rem]">
