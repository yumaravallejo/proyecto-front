  ...
  "relative w-full rounded-lg border px-4 py-3 text-sm grid has-[>svg]:grid-cols-[calc(var(--spacing)*4)_1fr] grid-cols-[0_1fr] has-[>svg]:gap-x-3 gap-y-0.5 items-start [&>svg]:size-4 [&>svg]:translate-y-0.5",
  {
    variants: {
      variant: {
        ...
        destructive:
          "text-red-800 border-red-800 [&>svg]:text-red-600 *:data-[slot=alert-description]:text-red-700",
        success:
          "text-green-800 border-green-800 [&>svg]:text-green-600 *:data-[slot=alert-description]:text-green-700",
      },
    },
    defaultVariants: {
      variant: "default",
